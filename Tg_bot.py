...
def send_but(URL, user_id, text):
    url_send_msg=URL+'sendmessage'
    reply_markup={"keyboard":[['1','2'],['3','4']], "one_time_keyboard": True}
    reply_markup=json.dumps(reply_markup)
    (requests.get(url_send_msg, data={'chat_id':user_id,'parse_mode':'HTML', 'text':text,'reply_markup':reply_markup}))   
...
def answer_msg(URL, user_id, msg, msg_id):
    if msg.startswith('/help'):
        ...
        send_msg(URL, user_id, "Try to print /help", msg_id)
