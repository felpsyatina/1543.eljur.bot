...
class Valica:
    def __init__(self, string):
        """
            >>> req = Valica("расписание 10в 20190404")
            ...
            >>> req = Valica("домашнее задание 10а 5г 5 апреля 20190405")
            >>> req.type, req.subs, req.list_of_dates
            ('homework', {'10А': {}, '5Г': {}}, ['20190501'])
    ...
    def extract_dates(self, string):
        ...
        regex_full_date = r"(((\d{4})([.,\/\s:;?^]|)(0[13578]|10|12)([.,\/\s:;?^]|)(0[1-9]|[12][0-9]|3[01]))|((\d{" \
                          r"4})([.,\/\s:;?^]|)(0[469]|11)([.,\/\s:;?^]|)([0][1-9]|[12][0-9]|30))|((\d{4})([.," \
                          r"\/\s:;?^]|)(02)([.,\/\s:;?^]|)(0[1-9]|1[0-9]|2[0-8]))|(([02468][048]00)([.,\/\s:;?^]|)(" \
                          r"02)([.,\/\s:;?^]|)(29))|(([13579][26]00)([.,\/\s:;?^]|)(02)([.,\/\s:;?^]|)(29))|(([0-9][" \
                          r"0-9][0][48])([.,\/\s:;?^]|)(02)([.,\/\s:;?^]|)(29))|(([0-9][0-9][2468][048])([.," \
                          r"\/\s:;?^]|)(02)([.,\/\s:;?^]|)(29))|(([0-9][0-9][13579][26])([.,\/\s:;?^]|)(02)([.," \
                          r"\/\s:;?^]|)(29))|(00000000)|(88888888)|(99999999)) "
